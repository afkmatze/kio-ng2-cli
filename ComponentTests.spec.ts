...
describe('testing components',function(){
  ...
  assertComponent('FilecardChapter')
  assertComponent('FilecardLead')
  assertComponent('FilecardMetaLead')
  assertComponent('ImageMagnifier')
  assertComponent('ImageMorph')
  assertComponent('Metabox')
  assertComponent('PanelChapter')
  assertComponent('PanelLead')
  assertComponent('PaperChapter')
  assertComponent('PaperLead')
  assertComponent('PostitChapter')
  assertComponent('SectionLeadIn')
  assertComponent('SectionLeadOut')
  assertComponent('TestContainer')
  assertComponent('TextLead')
  assertComponent('Image')
  assertComponent('FormattedText')
  assertComponent('SimpleText')

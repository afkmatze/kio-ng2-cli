import { KioNodeType, KioPrimitiveContentType, NamedComponent, NamedComponentStructure, NamedFragmentComponentStructure } from 'kio-ng2-data';
...
export declare const resolveComponentPath: (namedComponent: NamedComponent, targetRoot?: string) => string;
